...
public class Student {
    ...
    void Student(int averageEconomic, int averageMath,int foreignLanguages) {
        System.out.println("Name: " + name + " Surname: "+ surname + " Ocenka: " + (averageEconomic + averageMath + foreignLanguages) / 3);
    }
